...
/**
 * Fetches recent API request logs from the database.
 * These logs can be used by UI components to identify unregistered device or sensor attempts.
 ...
 */
export async function getUnregisteredDeviceOrSensorAttempts(limit: number = 20): Promise<ApiRequestLog[]> {
  try {
